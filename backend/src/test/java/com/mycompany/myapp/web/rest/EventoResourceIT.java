...
class EventoResourceIT {
    ...
    private static final Long DEFAULT_EVENTO_CATEDRA_ID = 1L;
    private static final Long UPDATED_EVENTO_CATEDRA_ID = 2L;
    ...
    public static Evento createEntity() {
        return new Evento()
            .eventoCatedraId(DEFAULT_EVENTO_CATEDRA_ID)
    ...
    public static Evento createUpdatedEntity() {
        return new Evento()
            .eventoCatedraId(UPDATED_EVENTO_CATEDRA_ID)
    ...
    @Test
    @Transactional
    void checkEventoCatedraIdIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        evento.setEventoCatedraId(null);
    ...
    void getAllEventos() throws Exception {
        ...
        restEventoMockMvc
            ...
            .andExpect(jsonPath("$.[*].eventoCatedraId").value(hasItem(DEFAULT_EVENTO_CATEDRA_ID.intValue())))
    ...
    void getEvento() throws Exception {
        ...
        restEventoMockMvc
            ...
            .andExpect(jsonPath("$.eventoCatedraId").value(DEFAULT_EVENTO_CATEDRA_ID.intValue()))
